...
{
    public class UploadUserPictureController : ApiController
    {
        private static Logger logger = LogManager.GetCurrentClassLogger();

        // GET: api/UploadUserPicture
        public IEnumerable<string> Get()
        {
            return new string[] { "value1", "value2" };
        }

        // GET: api/UploadUserPicture/5
        public string Get(int id)
        {
            return "value";
        }

        // POST: api/UploadUserPicture
        ...
        public Task<HttpResponseMessage> Post()
        {
            ...
            string rootPath = HttpContext.Current.Server.MapPath("~/uploadUserPic");
            ...
            ContinueWith<HttpResponseMessage>(t =>
            {
                ...
                1)
                        ...
                        outputForNir += " ---here5";
                        string fileRelativePath = "~/uploadUserPic/" + name;
            ...
            logger.Info("new user picture was uploaded!");
            return task;
        }


        // PUT: api/UploadUserPicture/5
        public void Put(int id, [FromBody]string value)
        {
        }

        // DELETE: api/UploadUserPicture/5
